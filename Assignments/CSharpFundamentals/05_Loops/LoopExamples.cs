...
namespace _05_Loops
{
    ...
    public class UnitTest1
    {
        ...
        {
            //While loop will repeat code as long as its condition its true
            int total = 1;
            ...
            while (total != 10)
            {
                ...
                //lines 20-22 all do the same things
            }
        ...
        public void ForLoops()
        {
            ...
            for (int i = 0; i < student.Length; i++)
            {
                ...
                //if ran it will say good morning to each person individually
            }
        }
        ...
        public void ForeachLoops()
        {
            ...
            //5: in keyword used to separate the individual and the collection
            //6: body
